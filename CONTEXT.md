...
- Azure colour filtering is capability-based: a regular, filled, or color variant is colour-capable when its descriptor has `preserveSourceColors`. The current generated observation is 1,216 colour-capable Azure families out of 1,374; these counts are not permanent contracts. Upstream variant keys and public deep links remain unchanged.
