...
- The collection selector uses Keel's `keel-select keel-select--sm` primitive. Frontend asset revisions and the `fluent-icon-browser-v12` app-shell cache advance together so installed clients receive selector and preview updates.
