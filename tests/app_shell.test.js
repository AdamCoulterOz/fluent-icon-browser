...
assert.deepEqual(
    ...
    ["keel.css?v=34", "style.css?v=37", "remote-icon-source.js?v=5", "script.js?v=21"]
);
...
assert.equal(readConstant("CACHE_NAME"), "fluent-icon-browser-v15");
