...
| HashiCorp Products | [hashicorp/design-system](https://github.com/hashicorp/design-system/tree/main/packages/flight-icons) | Package 5.1.0, MPL-2.0; independently pinned and digest-bound `Products` subset lock. | Published official `Products` category only, including Terraform, Vault, Packer, Nomad, and Consul. `Services` stays excluded. |
